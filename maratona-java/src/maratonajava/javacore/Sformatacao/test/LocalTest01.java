...
public class LocalTest01 {
    static void main(String[] args) {
        ...
        System.out.println(localeCH.getDisplayCountry()); //Exibe o pais que criamos esse Locale
        System.out.println(localeItaly.getDisplayLanguage()); //Mostra a lingua do Locale
    }
}